  ...
  return (
   ...
   <div >
    <Layout >
        ...
        <Navigation>
                <Link style={{ fontFamily:"Sofia", fontWeight:"bold" }}className="link"  to="/">Home</Link>
                <Link style={{ fontFamily:"Sofia", fontWeight:"bold"}} className ="link" to="/about">About Me</Link>
                <Link style={{ fontFamily:"Sofia", fontWeight:"bold"}} className ="link" to="/projects">Projects</Link>
                <Link style={{ fontFamily:"Sofia", fontWeight:"bold"}} className ="link" to="/contact">Contact</Link>
            </Navigation>
        </Header>
